...
const stripIconsApiGen = async (api) => {
  ...
  await fs__namespace.writeFile(
    pathe.join(
      pathe.dirname(node_url.fileURLToPath((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('variable-gen-CWmSjAxn.js', document.baseURI).href)))),
...
const fetchURL = async (url) => {
  ...
  await fs__namespace.writeFile(
    pathe.join(pathe.dirname(node_url.fileURLToPath((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('variable-gen-CWmSjAxn.js', document.baseURI).href)))), "../data/api-response.json"),
    stringify(stripped)
  );
};
...
const APIVFDirect = JSON.parse(
  fs__namespace$1.readFileSync(
    pathe.join(pathe.dirname(node_url.fileURLToPath((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('variable-gen-CWmSjAxn.js', document.baseURI).href)))), "../data/api-response-variable.json"),
    "utf8"
  )
);
...
const APIIconStatic = JSON.parse(
  fs__namespace$1.readFileSync(
    pathe.join(pathe.dirname(node_url.fileURLToPath((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('variable-gen-CWmSjAxn.js', document.baseURI).href)))), "../data/icons-static.json"),
    "utf8"
  )
);
...
const APIVariable = JSON.parse(
  fs__namespace$1.readFileSync(
    pathe.join(pathe.dirname(node_url.fileURLToPath((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('variable-gen-CWmSjAxn.js', document.baseURI).href)))), "../data/variable.json"),
    "utf8"
  )
);
const APILicense = JSON.parse(
  fs__namespace$1.readFileSync(
    pathe.join(pathe.dirname(node_url.fileURLToPath((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('variable-gen-CWmSjAxn.js', document.baseURI).href)))), "../data/licenses.json"),
    "utf8"
  )
);
const APIRegistry = JSON.parse(
  fs__namespace$1.readFileSync(
    pathe.join(pathe.dirname(node_url.fileURLToPath((typeof document === 'undefined' ? require('u' + 'rl').pathToFileURL(__filename).href : (_documentCurrentScript && _documentCurrentScript.tagName.toUpperCase() === 'SCRIPT' && _documentCurrentScript.src || new URL('variable-gen-CWmSjAxn.js', document.baseURI).href)))), "../data/axis-registry.json"),
    "utf8"
  )
);
