...
const fetchAllStaticFontCSS = async (font) => {
  ...
  return await Promise.all([
    fetchCSS(fontFamily, variantsList, apiv2.woff2),
    fetchCSS(fontFamily, variantsList, apiv2.woff),
    fetchCSS(fontFamily, variantsList, apiv2.ttf)
  ]);
};
...
const processQueue = async (font, variableFont, force) => {
  try {
    ...
    if (APIv2Hybrid[id] !== void 0 && font.lastModified === APIv2Hybrid[id].lastModified && variableFont.lastModified === APIv2Hybrid[id].lastModified && !force) {
